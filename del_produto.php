    ...
    <div class="container mt-3">
        ...
        <input type="hidden" name="id" id="id" value="<?php echo $result['id'] ?>">
            ...
            <div class="col-4">
                ...
                <input type="text" name="codigo" id="codigo" class="form-control" value="<?php echo $result['codigo'] ?>" readonly>
            </div></br>

            <div class="col-4">
                <label for="descricao">Descrição</label>
                <input type="text" name="descricao" id="descricao" class="form-control" value="<?php echo $result['descricao'] ?>" readonly>
            </div></br>
