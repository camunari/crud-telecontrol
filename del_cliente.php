    ...
    <div class="container mt-3">
        ...
        <form action="processa_cliente.php" class="" method="post">
            ...
            <div class="col-4">
                ...
                <input type="text" name="cpf" id="cpf" class="form-control" value="<?php echo $result['cpf'] ?>" readonly>
            </div></br>

            <div class="col-4">
                <label for="endereco">Endereço</label>
                <input type="text" name="endereco" id="endereco" class="form-control" value="<?php echo $result['endereco'] ?>" readonly>
            </div></br>

            <button type="submit" name="enviarDados" class="btn btn-danger" value="DEL">Deletar</button>
            <a href="/crudTelecontrol/list_clientes_cad.php" class="btn btn-primary">Cancelar</a>
